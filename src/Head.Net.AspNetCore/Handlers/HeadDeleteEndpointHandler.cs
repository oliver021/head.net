...
/// <summary>
/// Maps the DELETE /{id} endpoint for deleting entities.
/// Performs authorization checks and executes before/after hooks.
/// </summary>
/// <typeparam name="TEntity">The entity type.</typeparam>
/// <typeparam name="TKey">The entity's primary key type.</typeparam>
internal static class HeadDeleteEndpointHandler<TEntity, TKey>
    where TEntity : class, IHeadEntity<TKey>
    where TKey : notnull, IEquatable<TKey>
{
    /// <summary>
    /// Registers the delete endpoint with the route group.
    /// </summary>
        ...
        HeadUserContextService userService)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            await hookService.ExecuteBeforeDeleteAsync(id, cancellationToken);
            ...
            await hookService.ExecuteAfterDeleteAsync(deleted, cancellationToken);
